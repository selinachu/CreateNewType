...
final public class SemanticUtil {
   ...
   // cTakes types
   static private final String[] DRUG = { "T109", "T110", "T114", "T115",
                                          "T121", "T122", "T123", "T124", "T125", "T127",
                                          "T129", "T130", "T131", "T195", "T196", "T197", "T200" };
   static private final String[] DISO = { "T019", "T020", "T037", "T047", "T049", "T050", "T190", "T191" };
   static private final String[] FIND = { "T033", "T034", "T040", "T041", "T042", "T043", "T044", "T045", "T046",
                                          "T184" };
   static private final String[] PROC = { "T059", "T060", "T061", "T081" };
   static private final String[] ANAT = { "T021", "T022", "T023", "T029", "T030"};
   static private final String[] GENE = { "T999" }; //** gene and genome
   static private final String[] PRTN = { "T116", "T118", "T119", "T126"}; //**amino acid, peptide, protein, enzyme
   static private final String[] TISS = { "T024", "T025", "T026","T028","T085","T086","T087","T088"}; //** tissues
   ...
   static private final Collection<String> PRTN_TUIS = new HashSet<>( Arrays.asList( PRTN ) ); //**
   static private final Collection<String> TISS_TUIS = new HashSet<>( Arrays.asList( TISS ) ); //**
   ...
   static public Integer getTuiSemanticGroupId( final String tui ) {
      if ( ANAT_TUIS.contains( tui ) ) {
         ...
         return CONST.NE_TYPE_ID_DRUG;
          ...
          return CONST.NE_TYPE_ID_GENE; //11
      } else if ( PRTN_TUIS.contains( tui ) ) { //**
          return CONST.NE_TYPE_ID_PRTN; //12
      } else if ( TISS_TUIS.contains( tui ) ) { //**
          return CONST.NE_TYPE_ID_TISS; //13
      }
      return CONST.NE_TYPE_ID_UNKNOWN;
   }
